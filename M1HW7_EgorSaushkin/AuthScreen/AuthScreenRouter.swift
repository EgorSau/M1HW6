...
//	  }
	...
	//func navigateToSomewhere(source: AuthScreenViewController, destination: SomewhereViewController)
	//{
	...
	//func passDataToSomewhere(source: AuthScreenDataStore, destination: inout SomewhereDataStore)
	//{
